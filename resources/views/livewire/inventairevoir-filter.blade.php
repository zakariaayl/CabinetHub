<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100  text-gray-800 font-sans">
 <div class="max-w-7xl mx-auto p-6 mt-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
      <div class="text-center p-6 bg-white rounded-2xl  border border-gray-100 items-center justify-center hover:shadow-xl transition shadow-md ">
...
<div class="bg-white rounded-2xl p-6 relative border-t-4 border-red-500 hover:shadow-xl transition shadow-md ">
...
<div class="bg-white rounded-2xl p-6 relative border-t-4 border-green-500 hover:shadow-xl transition shadow-md ">
        ...
        @elseif ($ressource->pivot->etat_releve=="Usagé")
         ...
         <div class="bg-white rounded-2xl  p-6 relative border-t-4 border-yellow-400 hover:shadow-xl transition shadow-md ">
      ...
      plugins: {
        ...
        <div class="bg-white rounded-2xl  p-6 shadow-lg border border-gray-100 ">
          ...
          <div class="space-y-4">
            ...
            @if ($ressource->pivot->etat_releve=="Hors Service")
            <div class="flex items-start p-4 border-l-4 border-red-500 bg-red-100 rounded-xl shadow-md hover:shadow-xl transition">
            ...
            @elseif ($ressource->pivot->etat_releve=="Usagé")
            <div class="flex items-start p-4 border-l-4 border-yellow-500 bg-yellow-100 rounded-xl shadow-md hover:shadow-xl transition">
